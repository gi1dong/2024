...
$("footer .kor").click(function () {
  ...
  if ($("footer .wrap").hasClass("open")) {
    ...
    $("footer .arrow").css({transform:"rotate(90deg)"});
  } else {
...
var farmItemWrap = new Swiper(".farm-item-wrap.mo .mySwiper", {
  slidesPerView: 1,
  autoplay: {
    loop: true, 
    effect:'fade',
...
var benefits = new Swiper(".swiper.mySwiper.benefitsBox", {
slidesPerView: 1,
autoplay: {
  loop: true, 
  delay: 3200,
...
spaceBetween: 30,
navigation: {
  nextEl: ".benefitsBox .swiper-button-next",
  prevEl: ".benefitsBox .swiper-button-prev"
}
});
...
function collapse(element) {
  ...
  if (before && document.getElementsByClassName("activ")[0] != element) {  // 자신 이외에 이미 활성화된 버튼이 있으면
      ...
      before.classList.remove("activ");                  // 버튼 비활성화
  }
  element.classList.toggle("activ");         // 활성화 여부 toggle
