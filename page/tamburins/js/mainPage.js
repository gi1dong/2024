$(function(){  
  ...
  const screenWidth = $(window).width();
    ...
    const prdImg = new Swiper(".prd-img.mo .mySwiper", {
    spaceBetween: 30,
    effect: "fade",
    pagination: {
    ...
    {
    // 1024----------------------------화면 1024px 이상일 때 실행할 코드----------------------------------------------------------------------------------------
    //best seller 
    const info = new Swiper(".prd-img.pc .mySwiper", {
    breakpoints: {
      1379: {
        slidesPerView: 1.4,
        spaceBetween: 10,
    ...
    // 홍보센터
    const prdImg = new Swiper(".prdimg .mySwiper", {
      pagination: {
    ...
    // 영농정보
    $(".farm-item-wrap .flip").each(function () {
    shadowEff = gsap.timeline({
      ...
      .to(this, {
        boxShadow: "5px 2px 15px 2px rgba(0, 0, 0,0.7)",
        delay: $(this).data("d"),
      })
      .to(this, {
        boxShadow: "5px 2px 15px 2px rgba(0, 0, 0, 0.1)",
      })
    });
  }
  // aside menu
  ...
  const storeSwiper = new Swiper(".store-img .mySwiper", {
    scrollbar: {
  ...
  const rightMenu = new Swiper(".pc_menu .mySwiper", {
    navigation: {
  ...
  // 신상품 
  const experience = new Swiper(".new-launch-prd .mySwiper.prd-slide", {
    direction: "vertical",
    slidesPerView: 1,
    autoplay: {
      delay: 5500,
  ...
  const rightSwiper = new Swiper(".right .mySwiper", {
  loop: true,
  slidesPerView: 2,
  autoplay: {
    delay: 4500,
  ...
  const leftSwiper2 = new Swiper(".left .mySwiper2", {
  loop: true,
  spaceBetween: 10,
  navigation: {
